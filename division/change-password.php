...
{
$sql=mysqli_query($bd, "SELECT password FROM  user where password='".$pass."' && username= '".$name."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($bd, "update user set password='".'newpassword'."', updationDate='$currentTime' where username= '".$name."'");
