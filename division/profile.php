...
$query=mysqli_query($bd, "update user set username='$fname',phone='$contactno', where username='".$_SESSION['login']."'");
if($query)
{
...
<html lang="en">
 ...
 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      ...
                      <?php }?>
 <?php $query=mysqli_query($bd, "select * from user where username='".$_SESSION['login']."'");
