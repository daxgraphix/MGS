...
$query=mysql_query("insert into division(divisionCode,divisionName,description) values('$catcode','$catname','$description')");
if($query)
{
	echo "<script>alert('Division created');</script>";
}
else
{
