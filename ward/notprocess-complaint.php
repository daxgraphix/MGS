...
<tbody>
<?php 
$query=mysqli_query($bd, "select complaints.*,user.username as name from complaints join user on user.id=complaints.userid where complaints.usertype='village'");
