...
$query=mysqli_query($bd, "update user set username='$fname',phone='$contactno',
...
<html lang="en">
  <head>
    ...
    <title>MGS | User Change Password</title>

    <!-- Bootstrap core CSS -->
    <link href="assets/css/bootstrap.css" rel="stylesheet">
    <!--external css-->
    <link href="assetsw/font-awesome/css/font-awesome.css" rel="stylesheet" />
    <link rel="stylesheet" type="text/css" href="assets/js/bootstrap-datepicker/css/datepicker.css" />
    <link rel="stylesheet" type="text/css" href="assets/js/bootstrap-daterangepicker/daterangepicker.css" />
    <link href="assetsw/css/style.css" rel="stylesheet">
    <link href="assetsw/css/style-responsive.css" rel="stylesheet">
 ...
 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      ...
                      <?php }?>
 <?php $query=mysqli_query($bd, "select * from user where username='".$_SESSION['username']."'");
...
<button type="submit" name="submit" class="btn btn-primary">Submit</button>
    ...
    <script src="assetsw/js/jquery.js"></script>
    <script src="assetsw/js/bootstrap.min.js"></script>
    <script class="include" type="text/javascript" src="assetsw/js/jquery.dcjqaccordion.2.7.js"></script>
    <script src="assetsw/js/jquery.scrollTo.min.js"></script>
    <script src="assetsw/js/jquery.nicescroll.js" type="text/javascript"></script>


    <!--common script for all pages-->
    <script src="assetsw/js/common-scripts.js"></script>

    <!--script for this page-->
    <script src="assetsw/js/jquery-ui-1.9.2.custom.min.js"></script>

	<!--custom switch-->
	<script src="assetsw/js/bootstrap-switch.js"></script>
	
	<!--custom tagsinput-->
	<script src="assetsw/js/jquery.tagsinput.js"></script>
	
	<!--custom checkbox & radio-->
	
	<script type="text/javascript" src="assetsw/js/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
	<script type="text/javascript" src="assetsw/js/bootstrap-daterangepicker/date.js"></script>
	<script type="text/javascript" src="assetsw/js/bootstrap-daterangepicker/daterangepicker.js"></script>
	
	<script type="text/javascript" src="assetsw/js/bootstrap-inputmask/bootstrap-inputmask.min.js"></script>
	
	
	<script src="assetsw/js/form-component.js"></script>    
