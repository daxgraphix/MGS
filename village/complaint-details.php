...
<?php $st='closed';
$query=mysqli_query($bd, "select complaints.*,user.username as name,division.divisionName as catname from complaints join user on user.id=complaints.userid join division on division.id=complaints.division where complaints.usertype='hamlet' and complaintNumber='$id'");
