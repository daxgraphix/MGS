...
{
//$uid=$_POST['complaintNumber'];
$division=$_POST['division'];
$subcat=$_POST['ward'];
//$co=$_POST['complaintype'];
//$state=$_POST['state'];
//$noc=$_POST['noc'];
...
$query=mysqli_query($bd, "insert into complaints(userid,usertype,division,ward,complaintDetails)
 values('$uid','$usertype','$division','$subcat','$complaintdetials')");

if ($query>0) {
  $sql=mysqli_query($bd, "select complaintNumber from complaints  order by complaintNumber desc limit 1");
...
<?php $sql=mysqli_query($bd, "select id,divisionName from division ");
while ($rw=mysqli_fetch_array($sql)) {
  ?>
  <option value="<?php echo htmlentities($rw['id']);?>"><?php echo htmlentities($rw['divisionName']);?></option>
<?php
}
?>
</select>
 </div>
<label class="col-sm-2 col-sm-2 control-label">Ward </label>
 <div class="col-sm-4">
<select name="ward" id="ward" class="form-control"  required="" >
  
<?php $sql=mysqli_query($bd, "select id,ward from ward ");
while ($rw=mysqli_fetch_array($sql)) {
  ?>
  <option value="<?php echo htmlentities($rw['id']);?>"><?php echo htmlentities($rw['ward']);?></option>
<?php
}
?>
</select>
